...
def test():
    img_mask = np.asarray(PIL.Image.open('./testimages/aachen_000017_000019_gtFine_color.png'))
    img_mask.flags.writeable = True
    img_source = np.asarray(PIL.Image.open('./testimages/aachen_000017_000019_leftImg8bit.png'))
    img_source.flags.writeable = True
    img_target = np.asarray(PIL.Image.open('./testimages/aachen_000018_000019_leftImg8bit.png'))
    ...
    img_ret.save('./testimages/yo_ret.png')
